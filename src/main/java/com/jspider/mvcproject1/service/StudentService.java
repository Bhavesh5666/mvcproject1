...
import com.jspider.mvcproject1.repository.StudentRepository;
...
public class StudentService {
	...
	public StudentPOJO update(int id, String name, String email, String contact, String city, String username,
			String password) {
